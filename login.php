...
// de if statement en session start is nodig op het begin van pagina's met een ! voor de isset
...
if (isset($_POST['submit'])) {
    ...
    $email = $_POST['email'];
    // Server-side validation: checkt data binnen de php
    $errors = [];
    ...
    if (empty($errors)) {
        ...
        // Fixed: Only one query needed, check email first
        ...
        if (mysqli_num_rows($result) == 1) {
            ...
            if (password_verify($password, $row['password'])) {
                ...
                // Fixed: Get position from the database row, not empty variable
